...
chmod 600 ~/.ssh/authorized_keys</code></pre>
            ...
            <p>Uma chave protegida por frase-passe pede-a uma única vez, ao importá-la: a partir daí a frase-passe fica guardada com a chave, pelo que nenhuma ligação a volta a pedir, e é cifrada juntamente com a chave quando <strong>Cifrar dados sensíveis</strong> está ativo. Uma chave importada antes de isto acontecer tem de ser importada de novo — a lista de chaves assinala aquelas a que falta a frase-passe.</p>
            <div class="callout callout-ios">
                <div class="callout-label">// iOS</div>
