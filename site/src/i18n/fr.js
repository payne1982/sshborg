...
module.exports = {
  ...
  doc_toc: `            <li><a href="#adding-host">Ajouter un hôte</a></li>
            ...
            <li class="sub"><a href="#host-groups">Ordre de la liste</a></li>
  ...
  doc_host_groups: `
            ...
            <ul>
                <li><strong>Alphabétique</strong> (par défaut) — groupes par nom, hôtes par libellé dans chacun.</li>
                <li><strong>Utilisés récemment</strong> — l'hôte auquel vous vous êtes connecté en dernier passe en tête ; ceux jamais utilisés restent en bas.</li>
                <li><strong>Les plus utilisés</strong> — d'abord les hôtes ayant le plus de connexions.</li>
...
Host target
  ...
  doc_sessions: `
            ...
            <ul>
                <li>Appuyez sur un hôte pour ouvrir un terminal, ou choisissez <strong>Fichiers</strong> dans son menu pour ouvrir le gestionnaire de fichiers. Si l'hôte a déjà des sessions ouvertes, le même menu en ouvre d'autres.</li>
  ...
  doc_android_tv: `
            <h2>// ANDROID TV</h2>
            <p>SSHBorg fonctionne sur Android TV et Google TV. Il s'utilise avec le pavé directionnel de la télécommande, mais comme c'est une app très axée sur le texte, un clavier physique change tout.</p>
            <h3>Naviguer avec la télécommande</h3>
            <ul>
                <li><strong>Flèches du D-pad</strong> — déplacent le focus entre les lignes et les contrôles.</li>
                <li><strong>OK (centre)</strong> — l'action principale : se connecter à un hôte, ouvrir un dossier, télécharger un fichier, déployer un groupe.</li>
                <li><strong>Retour</strong> — remonter d'un niveau ou quitter l'écran.</li>
            </ul>
            <h3>Ouvrir le menu d'une ligne</h3>
            <p>Pour renommer, supprimer, modifier, dupliquer ou télécharger depuis une ligne, ouvrez son menu : appuyez sur la <strong>touche Menu (options)</strong> de la télécommande sur la ligne sélectionnée, ou <strong>maintenez OK</strong> (appui long). OK seul exécute l'action principale, pas le menu.</p>
            <h3>Saisie : utilisez un clavier physique</h3>
            <p>Un <strong>clavier physique — USB ou Bluetooth</strong> (Android TV prend en charge les deux) est fortement recommandé, et pratiquement indispensable pour le terminal. Avec lui, les champs de texte et le shell fonctionnent normalement.</p>
  ...
  doc_backup: `
            ...
            <ul>
                ...
                <li>Un hôte mis à jour conserve les données d'usage déjà présentes sur cet appareil — dernière connexion, compteur et position manuelle ; le fichier ne comble que ce qui manque.</li>
</ul>
            <h3>Format JSON</h3>
    ...
    "double_tap_action":     0
            ...
            <ul>
                ...
                <li><code>color</code> — couleur facultative de l'hôte (ARGB en entier 32 bits signé). Elle prime sur la couleur du groupe.</li>
                            <li><code>position</code> — place de l'hôte dans l'ordre manuel, comptée à l'intérieur de sa propre section (le bloc sans groupe, ou un groupe). Sans valeur, l'hôte est ajouté à la fin. Les groupes ont leur propre <code>position</code> dans le tableau <code>groups</code>.</li>
                <li><code>lastConnected</code> — date de la dernière connexion, en millisecondes depuis l'époque Unix. Alimente l'ordre « utilisés récemment ».</li>
                <li><code>connectCount</code> — nombre de sessions de terminal ouvertes vers cet hôte. Alimente l'ordre « les plus utilisés ».</li>
            </ul>
            <div class="callout callout-info">
  ...
  // ── changelog.html ─────────────────────────────────────────────────────────
  nav_changelog:               'Journal des versions',
  page_title_changelog:        'SSHBorg – Journal des versions',
  meta_description_changelog:  'Historique des versions de SSHBorg pour {PLATFORM} : ce qui a changé dans chacune.',
  changelog_subtitle:          'Toutes les versions publiées, de la plus récente.',
};
