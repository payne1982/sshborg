...
chmod 600 ~/.ssh/authorized_keys</code></pre>
            ...
            <p>Una clave protegida con frase de contraseña la pide una sola vez, al importarla: a partir de ahí la frase se guarda con la clave, así que ninguna conexión vuelve a pedirla, y se cifra junto con la clave cuando <strong>Cifrar datos sensibles</strong> está activado. Una clave importada antes de que fuera así hay que importarla de nuevo — la lista de claves señala aquellas a las que les falta la frase.</p>
            <div class="callout callout-ios">
                <div class="callout-label">// iOS</div>
