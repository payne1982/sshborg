...
openssl pkcs8 -in key.pem -out key_plain.pem</code></pre>
            ...
            <div class="callout callout-ios">
                <div class="callout-label">// iOS</div>
                En iOS una clave protegida con frase de contraseña aún no se puede usar: la frase se comprueba al importar la clave pero no se guarda, así que la conexión con esa clave falla. Usa una clave sin frase de contraseña, o genera una en la app.
            </div>`,
