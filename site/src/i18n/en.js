...
chmod 600 ~/.ssh/authorized_keys</code></pre>
            ...
            <p>A key protected by a passphrase asks for it once, when you import it: from then on the passphrase is kept with the key, so no connection asks for it again, and it is encrypted along with the key when <strong>Encrypt sensitive data</strong> is on. A key imported before this was the case has to be imported again — the key list marks the ones whose passphrase is missing.</p>
            <div class="callout callout-ios">
                <div class="callout-label">// iOS</div>
