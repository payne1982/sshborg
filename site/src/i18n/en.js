...
openssl pkcs8 -in key.pem -out key_plain.pem</code></pre>
            ...
            <div class="callout callout-ios">
                <div class="callout-label">// iOS</div>
                On iOS a passphrase-protected key cannot be used yet: the passphrase is checked when the key is imported but is not kept, so connecting with that key fails. Use a key without a passphrase, or generate one in the app.
            </div>`,
