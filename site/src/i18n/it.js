...
chmod 600 ~/.ssh/authorized_keys</code></pre>
            ...
            <p>Una chiave protetta da passphrase la chiede una volta sola, al momento dell'importazione: da lì in poi la passphrase resta conservata insieme alla chiave, così nessun collegamento la richiede di nuovo, ed è cifrata insieme alla chiave quando <strong>Cifra dati sensibili</strong> è attiva. Una chiave importata prima che funzionasse così va reimportata — nella lista delle chiavi sono segnalate quelle a cui manca la passphrase.</p>
            <div class="callout callout-ios">
                <div class="callout-label">// iOS</div>
