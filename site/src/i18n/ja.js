...
setopt APPEND_HISTORY SHARE_HISTORY</code></pre>
  ...
  doc_extra_keys: `
            ...
            <h3>レイアウトとカスタムバー</h3>
            <p>バーには複数のレイアウトがあります。バー上の <strong>⇄</strong> キーをタップすると切り替えられます。キーの代わりに利用できるバーの一覧が表示されるので、ひとつタップすれば完了です。選択は記憶されます。<strong>設定 → ターミナル → 拡張キーバーのレイアウト → カスタマイズ</strong>からもバーを選択・管理できます。</p>
            <ul>
