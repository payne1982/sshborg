...
An SSH client for Android.[^ios] Full terminal emulation, SFTP file manager, SSH key management, jump hosts, agent forwarding, and biometric lock — with no ads, no tracking, and no cloud.
...
[^ios]: Looking for the iOS repository? It is [payne1982/sshborg-ios](https://github.com/payne1982/sshborg-ios) — a separate app, written from scratch in Swift, sharing this one's design, its ten languages and its backup format.
